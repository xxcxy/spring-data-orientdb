package io.xxcxy.spring.data.orientdb.repository.config;
...
import io.xxcxy.spring.data.orientdb.repository.support.CollectOrientdbIdParserPostProcessor;
import io.xxcxy.spring.data.orientdb.repository.support.OrientdbIdParserHolder;
import io.xxcxy.spring.data.orientdb.repository.support.OrientdbRepositoryFactoryBean;
import io.xxcxy.spring.data.orientdb.repository.support.StringIdParser;
...
public class OrientdbRepositoryConfigurationExtension extends RepositoryConfigurationExtensionSupport {
    ...
    protected Collection<Class<? extends Annotation>> getIdentifyingAnnotations() {
        return Collections.singletonList(OrientdbEntity.class);
    }
