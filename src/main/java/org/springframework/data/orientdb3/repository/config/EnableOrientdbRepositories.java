...
public @interface EnableOrientdbRepositories {
     ...
     * {@code META-INFO/orientdb-named-queries.properties}.
     */
    ...
    Class<?> repositoryFactoryBeanClass() default OrientdbRepositoryFactoryBean.class;
    ...
    /**
     * Configures the name of the {@link org.springframework.data.orientdb3.support} bean definition
    ...
    /**
     * Configures whether to enable default transactions for Spring Data orientdb repositories. Defaults to {@literal true}.
